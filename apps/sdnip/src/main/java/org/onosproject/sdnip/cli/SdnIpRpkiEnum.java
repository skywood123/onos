...
public enum SdnIpRpkiEnum {

    ENABLE("enable"),
    DISABLE("disable"),
    SHOW("show"),
    SET("set"),
    VALIDATE_ALL_ROUTES("validateallroutes");

    private final String command;

    SdnIpRpkiEnum(final String command) {
     ...
     */
    public static SdnIpRpkiEnum enumFromString(String command) {
        if (command != null && !command.isEmpty()) {
            for (SdnIpRpkiEnum c : values()) {
